...
public class MockHttpServletResponse implements HttpServletResponse {
    ...
    private String getCookieHeader(Cookie cookie) {
        ...
        if (cookie instanceof MockCookie) {
            if (StringUtils.hasText(((MockCookie) cookie).getSameSite())) {
                buf.append("; SameSite=").append(((MockCookie) cookie).getSameSite());
            }
        }
     ...
     * <p>
     * As of Servlet 3.0, this method is also defined in
     * {@link HttpServletResponse}. As of Spring 3.1, it returns a stringified
     * value for Servlet 3.0 compatibility. Consider using
     ...
     * common {@link #encodeURL} method instead, applying to redirect URLs as
