...
public class MockAsyncContext implements AsyncContext {
    ...
    public void complete() {
        MockHttpServletRequest mockRequest = getNativeRequest(this.request, MockHttpServletRequest.class);
        if (mockRequest != null) {
    ...
    @Nullable
    static <T> T getNativeRequest(ServletRequest request, @Nullable Class<T> requiredType) {
