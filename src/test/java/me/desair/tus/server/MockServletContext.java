 ...
 *
 * <p>
 * Compatible with Servlet 3.1 but can be configured to expose a specific
 * version through {@link #setMajorVersion}/{@link #setMinorVersion}; default is
 * 3.1. Note that Servlet 3.1 support is limited: servlet, filter and listener
 ...
 * passing in a corresponding {@code MockServletContext} instance. Consider
 * configuring your {@code MockServletContext} with a
 * {@code FileSystemResourceLoader} in order to interpret resource paths as
 * relative filesystem locations.
 *
 * @author Rod Johnson
...
public class MockServletContext implements ServletContext {
     ...
     *
     * @param resourceBasePath the root directory of the WAR (should not end
     * with a slash)
     * @see org.springframework.core.io.DefaultResourceLoader
     */
     ...
     *
     * @param defaultServletName the name of the <em>default</em>
     * {@code Servlet}; never {@code null} or empty
    ...
    /**
     * This method always returns an
     * {@linkplain Collections#emptyMap empty map}.
     *
