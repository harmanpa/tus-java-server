...
public class MockCookie extends Cookie {
     ...
     *
     * @return the "Expires" attribute for this cookie, or {@code null} if not
     * set
     * @since 5.1.11
     */
    @Nullable
     ...
     * same-site requests if the supplied value is {@code "Strict"} or
     * cross-site requests if the supplied value is {@code "Lax"}.
     *
     * @see
     * <a href="https://tools.ietf.org/html/draft-ietf-httpbis-rfc6265bis#section-4.1.2.7">RFC6265
     * bis</a>
     */
     ...
     *
     * @return the "SameSite" attribute for this cookie, or {@code null} if not
     * set
     */
    @Nullable
     ...
     *
     * @param setCookieHeader the "Set-Cookie" value; never {@code null} or
     * empty
